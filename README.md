...
```
Create a fully populated unwanted groups file with /U and then edit this file and remove/comment out groups you _want_ to process.
- Everything _not_ removed or commented out will be ignored while processing.
...
Linux: This is resolved by dupe-checking in lowercase (see below under dupes); running on Linux will behave the same way as on Windows.
